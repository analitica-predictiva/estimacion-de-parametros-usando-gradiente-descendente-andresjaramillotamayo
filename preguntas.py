...
def pregunta_02():
    ...
    # Definir el parámetro inicial `params` como un arreglo de tamaño 3 con ceros
    params = np.zeros(shape=(3,))

    # Iterar a través de las iteraciones de optimización
    for _ in range(n_iterations):
        # Calcular el pronóstico con los parámetros actuales
